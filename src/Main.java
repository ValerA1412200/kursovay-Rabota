...
public class Main {
    public static void main(String[] args) {
        ...
        employee[0] = new Employee("Винокурова", "Ирина", "Максимовна", 1, 320000);
        employee[1] = new Employee("Макаров", "Вадим", "Владимирович", 1, 320000);
        employee[2] = new Employee("Филатов", "Юрий", "Дмитриевич", 1, 320000);
        employee[3] = new Employee("Печёрин", "Александр", "Игнатович", 2, 320000);
        employee[4] = new Employee("Логвинова", "Елена", "Игоревна", 2, 320000);
        employee[5] = new Employee("Кошелев", "Василий", "Вячеславович", 3, 550000);
